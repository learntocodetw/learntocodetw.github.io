...
var numberDivs=jQuery(".ticker").children().length;var first=jQuery(".ticker h1:nth-child(1)");setInterval(function(){var a=current*-90;first.css("margin-top",a+"px");if(current===numberDivs){first.css("margin-top","0px");current=1}else{current++}},2500);
